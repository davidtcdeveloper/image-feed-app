...
object KoinHelper : KoinComponent {
    ...
    fun getPhotoDetailsPresenter(photoId: String): PhotoDetailsPresenter = getKoin().get { parametersOf(photoId) }
    ...
    fun getCollectionDetailPresenter(collectionId: String): CollectionDetailPresenter = getKoin().get { parametersOf(collectionId) }

    fun getUserProfilePresenter(username: String): UserProfilePresenter = getKoin().get { parametersOf(username) }
}
